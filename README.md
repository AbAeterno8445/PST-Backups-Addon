...
Grab the [latest release](https://github.com/AbAeterno8445/PST-Backups-Addon/releases) and drop the .dll file in your Isaac installation directory. If you're using the Repentogon Launcher, the .dll must be dropped within the 'Repentogon' directory in your Isaac installation directory instead.
